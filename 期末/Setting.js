...
<table>
  ...
  <tbody>
    ...
    <tr><td>活動消息</td><td><textarea id="event" type="text" value=""/></textarea></td></tr>
  </tbody>
</table>
<br/>
...
Setting.save = function () {
  ...
  localStorage.setItem('Shop.event', Shop.event)
