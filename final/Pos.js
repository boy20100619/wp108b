const Pos = {
  ...
  <thead>
    <tr>
      ...
      <td>
        <img id="pic" src="肉燥飯.png" alt="無照片' height="100px" width="100px">
      </td>
  ...
  Pos.calcPrice = function () {
    ...
    if(a=="肉燥飯:40"){document.getElementById("pic").src = "肉燥飯.png";}
    if(a=="陽春麵:50"){document.getElementById("pic").src = "陽春麵.png";}
    if(a=="義大利麵:60"){document.getElementById("pic").src = "義大利麵.png";}
    if(a=="拉麵:80"){document.getElementById("pic").src = "拉麵.png";}
